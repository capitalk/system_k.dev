...
void Application::incremental_update_template(const T& message,
  ...
  void Application::onMessage(
    const FIX43::MarketDataIncrementalRefresh& message,
    const FIX::SessionID& sessionID) {
#ifdef LOG
    if (_config.print_debug) {
  ...
  void Application::onMessage(
    const FIX42::MarketDataIncrementalRefresh& message,
    const FIX::SessionID& sessionID) {
#ifdef LOG
    if (_config.print_debug) {
  ...
  void Application::onMessage(
    const FIX44::MarketDataRequestReject& message,
    const FIX::SessionID& sessionID) {
#ifdef LOG
    if (_config.print_debug) {
  ...
  void Application::onMessage(
    const FIX43::MarketDataRequestReject& message,
    const FIX::SessionID& sessionID) {
#ifdef LOG
    if (_config.print_debug) {
  ...
  void Application::onMessage(
    const FIX42::MarketDataRequestReject& message,
    const FIX::SessionID& sessionID) {
#ifdef LOG
    if (_config.print_debug) {
